...
--[[ Draw Texts ]]--
function drawSimpleText( msg, fnt, x, y, c, align )
	draw.SimpleText( msg, fnt, x, y, c, align )
end
...
function drawHUD()
	...
	-- Health/Armor Text
	drawSimpleText( ply:Health() > 0 and "Health: " .. ply:Health() or "Health: " .. 0, "LittleFont", bX+60, scrH+24, Color( 255, 255, 255 ) )
	drawSimpleText( ply:Armor() > 0 and "Armor: " .. ply:Armor() or "Armor: " .. 0, "LittleFont", bX+325, scrH+24, Color( 255, 255, 255 ) )

	-- Salary/Wallet Text
	drawSimpleText( "Wallet: " .. DarkRP.formatMoney( ply:getDarkRPVar( "money" ) ), "LittleFont", scrW-525, scrH+24, text, TEXT_ALIGN_LEFT )
	drawSimpleText( "Salary: " .. DarkRP.formatMoney( ply:getDarkRPVar( "salary" ) ), "LittleFont", scrW-255, scrH+24, text, TEXT_ALIGN_LEFT )
